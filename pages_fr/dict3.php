...
<div class="dict_content">
    <div id="dict_menu">
		...
		<td>
		<table id="nav-tbl">
        <td><a href="dictright35" class="<?php echo $right_class; ?>"><?php echo $locale['right']; ?></a></td>
        <td><a href="dictback35"  class="<?php echo $back_class; ?>"><?php echo $locale['back']; ?></a></td>
        <td><a href="dictlist35"  class="<?php echo $list_class; ?>"><?php echo $locale['anketas']; ?></a></td>

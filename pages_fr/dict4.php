...
<div class="py-5 text-center bg-light">
  <div class="container">
    <div id="dict_menu">
        ...
        <td><a href="dictright4" class="btn btn-outline-primary" padding="10px" ><?php echo $locale['right']; ?></a></td>
        <td><a href="dictback4"  class="btn btn-outline-primary" padding="10px"><?php echo $locale['back']; ?></a></td>
        <td><a href="dictlist4"  class="btn btn-outline-primary" padding="10px"><?php echo $locale['anketas']; ?></a></td>

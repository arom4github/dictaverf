	...
	<div class="wrapper row3">
		<main class="hoc container clear">
				...
				<nav class="sdb_holder">
					<ul>
						...
						<ul>
								...
								<li><a href="./search/fas2_red.php?method=inv&num=1"><?php echo $lang->dict->search_method->reaction->{$_SESSION["lang"]}; ?></a></li>
			...
			<div class="content three_quarter">
				<h1><?php echo $lang->navbar->fas2_red->{$_SESSION["lang"]}; ?></h1>
				<div id=about>
